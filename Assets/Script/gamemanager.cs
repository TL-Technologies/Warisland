...
public class gamemanager : MonoBehaviour
{
    ...
    public void onstartfirsttime()
    {
        if (!PlayerPrefs.HasKey("firsttime"))
        {
            ...
            PlayerPrefs.SetInt("solidlvl", 0);
            PlayerPrefs.SetInt("flaglvl", 0);
    ...
    public void setsolidlvl(int nbr)
    {
        PlayerPrefs.SetInt("solidlvl", nbr);
    }

    public int getsolidlvl()
    {
        return PlayerPrefs.GetInt("solidlvl");
    }


    public void setflaglvl(int nbr)
    {
        PlayerPrefs.SetInt("flaglvl", nbr);
    }

    public int getflaglvl()
    {
        return PlayerPrefs.GetInt("flaglvl");
    }
